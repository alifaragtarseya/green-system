...
use App\Http\Requests\Dashboard\OurWork\StoreOurWork;
use App\Models\OurWork;
use App\Models\Category;
use Illuminate\Http\Request;

class OurWorkController extends GeneralController
{
    protected $viewPath = 'our_works.';
    protected $path = 'our_works';
    private $route = 'dashboard.our_works';

    public function __construct(OurWork $model)
    {
    ...
    /**
     * Store Data in DB
     * @param StoreOurWork $request
     * @return \Illuminate\Http\RedirectResponse|\Illuminate\Routing\Redirector
     */
    public function store(StoreOurWork $request)
    {
     ...
     * @return \Illuminate\Http\RedirectResponse|\Illuminate\Routing\Redirector
     */
    public function update(StoreOurWork $request, $id)
    {
        // Get and Check Data
        $data = $this->GetItem($id);
        // Get data from request
