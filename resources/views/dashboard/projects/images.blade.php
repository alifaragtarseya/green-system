@php $titlePage = __('lang.project_images'); @endphp
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <a href="{{ route('dashboard.projects.view', $data->id) }}">{{ $data->title }}</a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
                                        ...
                                        <div style="padding: 0;" class="form-body form_add form_product">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <form id="fileupload" method="post" action="{{ route('dashboard.projects.images', $data->id) }}" enctype="multipart/form-data">
                                                        @csrf
                                                    ...
                                                    {% for (var i=0, file; file=o.files[i]; i++) { %}
                                                        <tr class="template-download fade">
                                                            ...
                                                            <td>
                                                                ...
                                                                <div>
                                                                    <a class="btn btn-info green-btn" href="{{ route('dashboard.projects.images', $data->id) }}">{{ __('lang.refresh') }} <i class="fa fa-refresh"></i> </a>
                                                                </div>
                                                            </td>
                                                            <td>
                                                            ...
                                                            @foreach($data->images as $image)
                                                                <div class="col-md-3 p_v_i">
                                                                    <div class="pre_img">
                                                                        ...
                                                                        <form action="{{ route('dashboard.projects.images.delete', ['id' => $data->id, 'img' => $image->id]) }}" method="post">
                                                                            @csrf
