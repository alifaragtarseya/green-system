                                ...
                                <div class="form-body form_add">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 pt-2">
                                            <label for="mission_description_-{{ $locale }}"> {{ __('lang.description_' . $locale) }}</label>
                                            <textarea name="mission_description_{{ $locale }}" class="form-control" id="" cols="1" rows="10">
                                                {{ old('mission_description_' . $locale,optional($my_settings->where('key', 'mission_description_' . $locale))->first()->value ?? '',) }}
                                            </textarea>
