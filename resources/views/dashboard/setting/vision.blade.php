@php $titlePage = __('lang.our_vision'); @endphp
                                ...
                                <div class="form-body form_add">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 pt-2">
                                            <label for="vision_description-{{ $locale }}"> {{ __('lang.description_' . $locale) }}</label>
                                            <textarea name="vision_description_{{ $locale }}" class="form-control" id="" cols="1" rows="10">
                                                {{ old('vision_description_' . $locale,optional($my_settings->where('key', 'vision_description_' . $locale))->first()->value ?? '',) }}
                                            </textarea>
