@php $titlePage = __('lang.edit_category'); @endphp
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <a href="{{ route('dashboard.categories.view', $data->id) }}">{{ $data->title }}</a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
                    ...
                    <div class="tab-pane" id="tab_2">
                        <div class="portlet light ">
                            ...
                            <div class="portlet-body form">
                                ...
                                <form method="post" action="{{ route('dashboard.categories.update', $data->id) }}" enctype="multipart/form-data">
                                    @csrf
