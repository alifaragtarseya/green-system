                ...
                <div class="tab-pane fade active in" id="General">
                    <div class="col-lg-12">
                        <div class="form-group {{ $errors->has('type') ? 'has-error' : '' }}">
                            <label for="type">{{ __('lang.type') }} <span class="required">*</span></label>
                            <select required id="type" data-title="{{ __('lang.choose') }} {{ __('lang.type') }}" name="type" data-live-search="true" class="form-control bs-select" >
                                <option {{ old('type', $data->type ?? null) == 'global' ? 'selected' : '' }} value="global">{{ __('lang.global') }}</option>
                                <option {{ old('type', $data->type ?? null) == 'technical' ? 'selected' : '' }} value="technical">{{ __('lang.technical') }}</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="col-md-6">
            <div class="row">
                <div class=" col-md-9">
                    ...
                    <a href="{{ route('dashboard.features') }}" class="btn default">{{ __('lang.cancel') }}</a>
                </div>
            </div>
        </div>
    </div>
