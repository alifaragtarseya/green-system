@php $titlePage = __('lang.edit_service'); @endphp
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <a href="{{ route('dashboard.services.view', $data->id) }}">{{ $data->title }}</a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
                    ...
                    <div class="tab-pane" id="tab_2">
                        <div class="portlet light ">
                            ...
                            <div class="portlet-body form">
                                ...
                                <form method="post" action="{{ route('dashboard.services.update', $data->id) }}" enctype="multipart/form-data">
                                    @csrf
