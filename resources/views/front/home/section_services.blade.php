        ...
        <div class="row">
            ...
            <div class="owl-carousel owl-theme services-carousel">
                ...
                <div class="item pt-3 wow zoomInDown" style="height: 100%" >
                    <div class="card border-0 p-2" style="height: 100%; border-radius: 20px;">
                        ...
                        <i style="font-size: 40px;padding: 0px 15px;background: #008444;color: white;border-radius: 50%;" class="icon_view {{ $item->icon }}"></i></span>
                        <div class="card-body  ">
                            <br>
            ...
            <div class="col-md-12 pt-5 text-center">
                <div class="contact-btn">
                    <a href="{{ route('front.services')}}" style="border-radius: 0px 16px 0px 16px" class="btn "><i class="las la-arrow-right"></i> {{ __('lang.view_all_services') }} </a>
                </div>
            </div>
        </div>
