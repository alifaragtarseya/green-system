<div class="footer-area " style="background-image: url('{{ asset('front/icon/footer.png') }}')">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-12 {{ isMobile() ? ' pt-4' : '' }}">
                        <div class="single-footer-widget">
                            <div class="logo">
                    ...
                    <div class="col-lg-2 pt-4  col-md-6 col-12 {{ isMobile() ? ' pt-4' : '' }}">
                    ...
                    <div class="col-lg-3 pt-4  col-md-6 col-12 {{ isMobile() ? ' pt-4' : '' }}">
                        <div class="single-footer-widget pl-5">
                            ...
                            <ul class="quick-links pt-4">
                                ...
                                <li class="text-muted">
                                    <a href="#"><b
                                            class=" text-white">{{ __('lang.terms_conditions') }}</b></a>
                                </li>
                                <li class="text-muted">
                    ...
                    <div class="col-lg-3 pt-4  col-md-6 col-12 {{ isMobile() ? ' pt-4' : '' }}">
                        ...
                        <div class="single-footer-widget w3-display-container w3-round"
                            style="width: 100%;height: 60px;background-color: #fff;padding-left: 5px;padding-right: 5px">



                            <input type="email" name="email" class="border-0 text-{{ isRtl() ? 'right' : 'left' }} p-3"
                                style="width: 100%;background-color: transparent!important;outline: none" placeholder="ex@email.com"
                                autocomplete="new-email" id="">

                            <div class="w3-display-top{{ !isRtl() ? 'right' : 'left' }}"  >
                                <button
                                    class="btn w3-round"
                                    style="background: #008444;padding: 20px 23px 10px;height: 60px">
